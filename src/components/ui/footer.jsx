...
function Footer() {
  return (
    <section className="bg-[#06091A]">
      <section className="pt-10 md:pt-60 px-2 md:px-20 lg:px-52 pb-10 md:pb-16 flex flex-col items-center gap-16">
        <figure>
          <img src={logo} alt="logo" />
        </figure>
        <nav className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-48 lg:justify-center lg:justify-items-center">
          <div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 md:mt-4 text-[#FFFFFF99] leading-6.5 lg:list-disc list-inside">
              <li>Home</li>
              <li>Services</li>
              <li>About</li>
              <li>Contact</li>
