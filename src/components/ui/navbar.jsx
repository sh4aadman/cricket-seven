  ...
  return (
    <nav className="flex justify-between">
      ...
      <section className="flex items-center gap-14">
        <ul className="flex gap-14 text-[#131313] text-lg opacity-70">
          <li><a href="#Home">Home</a></li>
          <li><a href="#Fixturess">Fixture</a></li>
        ...
        <section className="font-medium text-[#131313] border border-[#1313131A] px-5 py-4 rounded-xl">
          ...
          <i class="fa-solid fa-dollar-sign ml-2 p-1 border-2 rounded-full"></i>
        </section>
      </section>
    </nav>
  );
