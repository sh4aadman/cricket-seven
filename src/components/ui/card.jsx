...
function Card() {
  return (
    <section className="p-6 border rounded-xl">
      <figure>
        <img className="rounded-xl aspect-3/2 object-cover" src={playerImg} alt="player-img" />
      </figure>
      ...
      <section className="my-4 flex justify-between items-center">
        ...
        <p className="px-2.5 py-1 border rounded-md text-sm bg-[#1313130D]">Role</p>
          </section>
          ...
          <section className="space-y-3">
             ...
             <h4 className="font-bold">Preferred Hand</h4> 
              <div className="flex justify-between">
                  ...
                  <button className="px-2.5 py-1 border rounded-md text-sm">Choose Player</button>
             </div>
          </section>
    </section>
  );
